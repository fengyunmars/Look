...
package com.fengyun.look.looklook.widget;
...
/**
 * A view group that draws a badge 徽章 徽章 标记 drawable on top of it's contents.
 */
public class BadgedFourThreeImageView extends FourThreeImageView {
    ...
    private static class GifBadge extends Drawable {
        ...
        private static final String TYPEFACE = "sans-serif-black"; // 字体
        ...
        GifBadge(Context context) {
            if (bitmap == null) {
                ...
                // punch out 下班打卡 the word 'GIF', leaving transparency
